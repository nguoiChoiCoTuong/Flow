...
async function fetchNASAData(lat, lon) {
  ...
  const url = `https://power.larc.nasa.gov/api/temporal/daily/point?parameters=T2M,RH2M,WS2M,PS&community=RE&longitude=${lon}&latitude=${lat}&start=${start}&end=${end}&format=JSON`;
